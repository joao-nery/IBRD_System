...
export default function WhereLocalization() {
  return (
    <div className="mt-20 flex flex-col justify-center items-center">
      ...
      <section className="flex flex-col items-center lg:items-start lg:flex-row gap-10 mt-8 lg:mt-15">
        <Link
          href={
          ...
          <Image
            ...
            width={1000}
            height={0}
            className="rounded-2xl w-[300px] lg:w-[600px] shadow-2xl hover:scale-105 transition-all"
